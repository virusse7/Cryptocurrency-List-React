...
const CryptocurrencyTile = ({
    ...
    const formattedPercentage = percentChange > 0 ? `+${percentChange}` : `${percentChange}`;
                ...
                <div className="flex justify-between">
                    <div className="flex flex-row gap-2 justify-center items-center">
                        <div className="relative">
                            ...
                            <div className="absolute bottom-0.5 right-2 -space-x-1.5 flex ">
                                <img className="w-[12px] h-[12px] " src={binanceImage} alt="Near Logo" />
                                <img className="w-[12px] h-[12px] " src={binanceImage} alt="Near Logo" />
                                <img className="w-[12px] h-[12px] " src={binanceImage} alt="Near Logo" />
                            </div>
                        </div>
